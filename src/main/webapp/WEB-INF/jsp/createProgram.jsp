                    ...
                    <form method="post" role="form" class="php-email-form pt-5">
                        <div class="form-row">
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <input type="number" class="form-control" name="fees" id="fees" placeholder="Fees" data-rule="fees" data-msg="Please enter a valid fees" />
                                <div class="validate"></div>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="col-md-6 form-group">
                                ...
                                <input type="date" name="startDate" class="form-control" id="startDate" placeholder="Start Date" data-rule="minlen:3" data-msg="Please enter at a valid date" />
                                <div class="validate"></div>
                            </div>
                            <div class="col-md-6 form-group">
                                <label for="endDate">End Date:</label>
                                <input type="date" name="endDate" class="form-control" id="endDate" placeholder="End Date" data-rule="minlen:3" data-msg="Please enter at a valid date" />
                                <div class="validate"></div>
                            </div>
                        </div>
